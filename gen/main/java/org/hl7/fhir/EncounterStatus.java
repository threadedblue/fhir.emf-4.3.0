...
public interface EncounterStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.EncounterStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.EncounterStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(EncounterStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getEncounterStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	EncounterStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(EncounterStatusEnum value);
