...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Guide Parameter Code Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getGuideParameterCodeEnum()
 * @model extendedMetaData="name='GuideParameterCodeEnum'"
 * @generated
 */
public enum GuideParameterCodeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Guide Parameter Code Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final GuideParameterCodeEnum[] VALUES_ARRAY =
		new GuideParameterCodeEnum[] {
			APPLY,
			PATH_RESOURCE,
			PATH_PAGES,
			PATH_TX_CACHE,
	...
	/**
	 * A public read-only list of all the '<em><b>Guide Parameter Code Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<GuideParameterCodeEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Guide Parameter Code Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static GuideParameterCodeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GuideParameterCodeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Guide Parameter Code Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static GuideParameterCodeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GuideParameterCodeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Guide Parameter Code Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static GuideParameterCodeEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private GuideParameterCodeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
