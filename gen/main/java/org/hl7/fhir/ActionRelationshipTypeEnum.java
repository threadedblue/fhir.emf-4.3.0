...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Action Relationship Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getActionRelationshipTypeEnum()
 * @model extendedMetaData="name='ActionRelationshipTypeEnum'"
 * @generated
 */
public enum ActionRelationshipTypeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Action Relationship Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ActionRelationshipTypeEnum[] VALUES_ARRAY =
		new ActionRelationshipTypeEnum[] {
			BEFORE_START,
			BEFORE,
			BEFORE_END,
	...
	/**
	 * A public read-only list of all the '<em><b>Action Relationship Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ActionRelationshipTypeEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Action Relationship Type Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ActionRelationshipTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ActionRelationshipTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Action Relationship Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ActionRelationshipTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ActionRelationshipTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Action Relationship Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ActionRelationshipTypeEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ActionRelationshipTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
