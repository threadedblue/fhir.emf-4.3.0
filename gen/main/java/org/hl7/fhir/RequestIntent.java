...
public interface RequestIntent extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.RequestIntentEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.RequestIntentEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(RequestIntentEnum)
	 * @see org.hl7.fhir.FhirPackage#getRequestIntent_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	RequestIntentEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(RequestIntentEnum value);
