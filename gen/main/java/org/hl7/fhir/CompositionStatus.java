...
public interface CompositionStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.CompositionStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.CompositionStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(CompositionStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getCompositionStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	CompositionStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(CompositionStatusEnum value);
