...
public interface SPDXLicense extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.SPDXLicenseEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.SPDXLicenseEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(SPDXLicenseEnum)
	 * @see org.hl7.fhir.FhirPackage#getSPDXLicense_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	SPDXLicenseEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(SPDXLicenseEnum value);
