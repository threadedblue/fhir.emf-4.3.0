...
public interface SupplyDeliveryStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.SupplyDeliveryStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.SupplyDeliveryStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(SupplyDeliveryStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getSupplyDeliveryStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	SupplyDeliveryStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(SupplyDeliveryStatusEnum value);
