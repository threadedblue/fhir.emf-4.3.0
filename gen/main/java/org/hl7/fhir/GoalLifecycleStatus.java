...
public interface GoalLifecycleStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.GoalLifecycleStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.GoalLifecycleStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(GoalLifecycleStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getGoalLifecycleStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	GoalLifecycleStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(GoalLifecycleStatusEnum value);
