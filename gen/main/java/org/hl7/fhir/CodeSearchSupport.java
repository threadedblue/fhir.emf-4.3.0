...
public interface CodeSearchSupport extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.CodeSearchSupportEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.CodeSearchSupportEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(CodeSearchSupportEnum)
	 * @see org.hl7.fhir.FhirPackage#getCodeSearchSupport_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	CodeSearchSupportEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(CodeSearchSupportEnum value);
