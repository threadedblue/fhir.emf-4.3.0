...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>FHIR All Types Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getFHIRAllTypesEnum()
 * @model extendedMetaData="name='FHIRAllTypesEnum'"
 * @generated
 */
public enum FHIRAllTypesEnum implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int TYPE_VALUE = 207;
	 ...
	 * @ordered
	 */
	public static final int ANY_VALUE = 208;

	/**
	 * An array of all the '<em><b>FHIR All Types Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FHIRAllTypesEnum[] VALUES_ARRAY =
		new FHIRAllTypesEnum[] {
			ADDRESS,
			AGE,
			ANNOTATION,
			ATTACHMENT,
	...
	/**
	 * A public read-only list of all the '<em><b>FHIR All Types Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FHIRAllTypesEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>FHIR All Types Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FHIRAllTypesEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FHIRAllTypesEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>FHIR All Types Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FHIRAllTypesEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FHIRAllTypesEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>FHIR All Types Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FHIRAllTypesEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FHIRAllTypesEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
