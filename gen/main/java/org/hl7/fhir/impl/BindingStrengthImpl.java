...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Binding Strength</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.BindingStrengthImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BindingStrengthImpl extends ElementImpl implements BindingStrength {
	/**
	 ...
	 * @ordered
	 */
	protected static final BindingStrengthEnum VALUE_EDEFAULT = BindingStrengthEnum.REQUIRED;
	 ...
	 * @ordered
	 */
	protected BindingStrengthEnum value = VALUE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getBindingStrength();
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.BINDING_STRENGTH__VALUE:
				setValue((BindingStrengthEnum)newValue);
				return;
		}
