...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Capability Statement Operation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class CapabilityStatementOperationImpl extends BackboneElementImpl implements CapabilityStatementOperation {
	 ...
	 * @generated
	 */
	protected CapabilityStatementOperationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getCapabilityStatementOperation();
	}
	...
	public NotificationChain basicSetName(org.hl7.fhir.String newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT_OPERATION__NAME, oldName, newName);
	...
	public void setName(org.hl7.fhir.String newName) {
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT_OPERATION__NAME, null, msgs);
			if (newName != null)
				msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT_OPERATION__NAME, null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT_OPERATION__NAME, newName, newName));
	}
	...
	public void setDefinition(Canonical newDefinition) {
		if (newDefinition != definition) {
			NotificationChain msgs = null;
			if (definition != null)
				msgs = ((InternalEObject)definition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT_OPERATION__DEFINITION, null, msgs);
			if (newDefinition != null)
				msgs = ((InternalEObject)newDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.CAPABILITY_STATEMENT_OPERATION__DEFINITION, null, msgs);
			msgs = basicSetDefinition(newDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.CAPABILITY_STATEMENT_OPERATION__DEFINITION, newDefinition, newDefinition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.CAPABILITY_STATEMENT_OPERATION__NAME:
...
} //CapabilityStatementOperationImpl
