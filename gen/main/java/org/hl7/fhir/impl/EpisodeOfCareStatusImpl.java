...
public class EpisodeOfCareStatusImpl extends ElementImpl implements EpisodeOfCareStatus {
	 ...
	 * @ordered
	 */
	protected static final EpisodeOfCareStatusEnum VALUE_EDEFAULT = EpisodeOfCareStatusEnum.PLANNED;
	 ...
	 * @ordered
	 */
	protected EpisodeOfCareStatusEnum value = VALUE_EDEFAULT;
	 ...
	 */
	@Override
	public EpisodeOfCareStatusEnum getValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(EpisodeOfCareStatusEnum newValue) {
		EpisodeOfCareStatusEnum oldValue = value;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.EPISODE_OF_CARE_STATUS__VALUE:
				setValue((EpisodeOfCareStatusEnum)newValue);
				return;
		}
