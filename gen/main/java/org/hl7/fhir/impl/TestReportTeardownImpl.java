 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.TestReportTeardownImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestReportTeardownImpl extends BackboneElementImpl implements TestReportTeardown {
	 ...
	 * @ordered
	 */
	protected EList<TestReportAction2> action;
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getTestReportTeardown();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.TEST_REPORT_TEARDOWN__ACTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.TEST_REPORT_TEARDOWN__ACTION:
				getAction().clear();
				getAction().addAll((Collection<? extends TestReportAction2>)newValue);
				return;
		}
