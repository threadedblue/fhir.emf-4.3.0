...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Medication Administration Performer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class MedicationAdministrationPerformerImpl extends BackboneElementImpl implements MedicationAdministrationPerformer {
	 ...
	 * @generated
	 */
	protected MedicationAdministrationPerformerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getMedicationAdministrationPerformer();
	}
	...
	public NotificationChain basicSetActor(Reference newActor, NotificationChain msgs) {
		...
		actor = newActor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ACTOR, oldActor, newActor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setActor(Reference newActor) {
		if (newActor != actor) {
			NotificationChain msgs = null;
			if (actor != null)
				msgs = ((InternalEObject)actor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ACTOR, null, msgs);
			if (newActor != null)
				msgs = ((InternalEObject)newActor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ACTOR, null, msgs);
			msgs = basicSetActor(newActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICATION_ADMINISTRATION_PERFORMER__ACTOR, newActor, newActor));
	}
...
} //MedicationAdministrationPerformerImpl
