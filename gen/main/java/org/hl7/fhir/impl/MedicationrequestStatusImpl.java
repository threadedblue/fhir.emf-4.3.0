...
public class MedicationrequestStatusImpl extends ElementImpl implements MedicationrequestStatus {
	 ...
	 * @ordered
	 */
	protected static final MedicationrequestStatusEnum VALUE_EDEFAULT = MedicationrequestStatusEnum.ACTIVE;
	 ...
	 * @ordered
	 */
	protected MedicationrequestStatusEnum value = VALUE_EDEFAULT;
	 ...
	 */
	@Override
	public MedicationrequestStatusEnum getValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(MedicationrequestStatusEnum newValue) {
		MedicationrequestStatusEnum oldValue = value;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.MEDICATIONREQUEST_STATUS__VALUE:
				setValue((MedicationrequestStatusEnum)newValue);
				return;
		}
