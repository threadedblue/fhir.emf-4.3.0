...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Instant</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.InstantImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstantImpl extends ElementImpl implements Instant {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getInstant();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.INSTANT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirPackage.INSTANT__VALUE:
				return getValue();
		}
