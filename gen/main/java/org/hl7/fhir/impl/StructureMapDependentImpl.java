 ...
 *   <li>{@link org.hl7.fhir.impl.StructureMapDependentImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureMapDependentImpl extends BackboneElementImpl implements StructureMapDependent {
	 ...
	 * @ordered
	 */
	protected EList<org.hl7.fhir.String> variable;
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_MAP_DEPENDENT__VARIABLE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FhirPackage.STRUCTURE_MAP_DEPENDENT__VARIABLE:
				getVariable().clear();
				getVariable().addAll((Collection<? extends org.hl7.fhir.String>)newValue);
				return;
		}
