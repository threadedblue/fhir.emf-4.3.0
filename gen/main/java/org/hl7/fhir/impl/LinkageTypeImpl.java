...
public class LinkageTypeImpl extends ElementImpl implements LinkageType {
	 ...
	 * @ordered
	 */
	protected static final LinkageTypeEnum VALUE_EDEFAULT = LinkageTypeEnum.SOURCE;
	 ...
	 * @ordered
	 */
	protected LinkageTypeEnum value = VALUE_EDEFAULT;
	 ...
	 */
	@Override
	public LinkageTypeEnum getValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(LinkageTypeEnum newValue) {
		LinkageTypeEnum oldValue = value;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.LINKAGE_TYPE__VALUE:
				setValue((LinkageTypeEnum)newValue);
				return;
		}
