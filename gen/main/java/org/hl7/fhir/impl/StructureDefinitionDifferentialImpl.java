 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.StructureDefinitionDifferentialImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDefinitionDifferentialImpl extends BackboneElementImpl implements StructureDefinitionDifferential {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getStructureDefinitionDifferential();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.STRUCTURE_DEFINITION_DIFFERENTIAL__ELEMENT:
