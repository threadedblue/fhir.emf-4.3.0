 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.PractitionerRoleAvailableTimeImpl#getDaysOfWeek <em>Days Of Week</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.PractitionerRoleAvailableTimeImpl#getAllDay <em>All Day</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.PractitionerRoleAvailableTimeImpl#getAvailableStartTime <em>Available Start Time</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.PractitionerRoleAvailableTimeImpl#getAvailableEndTime <em>Available End Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PractitionerRoleAvailableTimeImpl extends BackboneElementImpl implements PractitionerRoleAvailableTime {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getPractitionerRoleAvailableTime();
	}
	...
	public NotificationChain basicSetAllDay(org.hl7.fhir.Boolean newAllDay, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__ALL_DAY, oldAllDay, newAllDay);
	...
	public void setAllDay(org.hl7.fhir.Boolean newAllDay) {
		if (newAllDay != allDay) {
			...
			if (allDay != null)
				msgs = ((InternalEObject)allDay).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__ALL_DAY, null, msgs);
			if (newAllDay != null)
				msgs = ((InternalEObject)newAllDay).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__ALL_DAY, null, msgs);
			msgs = basicSetAllDay(newAllDay, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__ALL_DAY, newAllDay, newAllDay));
	}
	...
	public NotificationChain basicSetAvailableStartTime(Time newAvailableStartTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME, oldAvailableStartTime, newAvailableStartTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAvailableStartTime(Time newAvailableStartTime) {
		if (newAvailableStartTime != availableStartTime) {
			...
			if (availableStartTime != null)
				msgs = ((InternalEObject)availableStartTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME, null, msgs);
			if (newAvailableStartTime != null)
				msgs = ((InternalEObject)newAvailableStartTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME, null, msgs);
			msgs = basicSetAvailableStartTime(newAvailableStartTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME, newAvailableStartTime, newAvailableStartTime));
	}
	...
	public NotificationChain basicSetAvailableEndTime(Time newAvailableEndTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME, oldAvailableEndTime, newAvailableEndTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAvailableEndTime(Time newAvailableEndTime) {
		if (newAvailableEndTime != availableEndTime) {
			...
			if (availableEndTime != null)
				msgs = ((InternalEObject)availableEndTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME, null, msgs);
			if (newAvailableEndTime != null)
				msgs = ((InternalEObject)newAvailableEndTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME, null, msgs);
			msgs = basicSetAvailableEndTime(newAvailableEndTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME, newAvailableEndTime, newAvailableEndTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_START_TIME:
				return basicSetAvailableStartTime(null, msgs);
			case FhirPackage.PRACTITIONER_ROLE_AVAILABLE_TIME__AVAILABLE_END_TIME:
