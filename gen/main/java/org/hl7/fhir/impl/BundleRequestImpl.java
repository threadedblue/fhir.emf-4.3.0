...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bundle Request</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class BundleRequestImpl extends BackboneElementImpl implements BundleRequest {
	...
	public NotificationChain basicSetMethod(HTTPVerb newMethod, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__METHOD, oldMethod, newMethod);
	...
	public void setMethod(HTTPVerb newMethod) {
		if (newMethod != method) {
			...
			if (method != null)
				msgs = ((InternalEObject)method).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__METHOD, null, msgs);
			if (newMethod != null)
				msgs = ((InternalEObject)newMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__METHOD, null, msgs);
			msgs = basicSetMethod(newMethod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__METHOD, newMethod, newMethod));
	}
	...
	public NotificationChain basicSetUrl(Uri newUrl, NotificationChain msgs) {
		...
		url = newUrl;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__URL, oldUrl, newUrl);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUrl(Uri newUrl) {
		if (newUrl != url) {
			NotificationChain msgs = null;
			if (url != null)
				msgs = ((InternalEObject)url).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__URL, null, msgs);
			if (newUrl != null)
				msgs = ((InternalEObject)newUrl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__URL, null, msgs);
			msgs = basicSetUrl(newUrl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__URL, newUrl, newUrl));
	}
	...
	public NotificationChain basicSetIfNoneMatch(org.hl7.fhir.String newIfNoneMatch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__IF_NONE_MATCH, oldIfNoneMatch, newIfNoneMatch);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfNoneMatch(org.hl7.fhir.String newIfNoneMatch) {
		if (newIfNoneMatch != ifNoneMatch) {
			NotificationChain msgs = null;
			if (ifNoneMatch != null)
				msgs = ((InternalEObject)ifNoneMatch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__IF_NONE_MATCH, null, msgs);
			if (newIfNoneMatch != null)
				msgs = ((InternalEObject)newIfNoneMatch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__IF_NONE_MATCH, null, msgs);
			msgs = basicSetIfNoneMatch(newIfNoneMatch, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__IF_NONE_MATCH, newIfNoneMatch, newIfNoneMatch));
	}
	...
	public NotificationChain basicSetIfModifiedSince(Instant newIfModifiedSince, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__IF_MODIFIED_SINCE, oldIfModifiedSince, newIfModifiedSince);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfModifiedSince(Instant newIfModifiedSince) {
		if (newIfModifiedSince != ifModifiedSince) {
			...
			if (ifModifiedSince != null)
				msgs = ((InternalEObject)ifModifiedSince).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__IF_MODIFIED_SINCE, null, msgs);
			if (newIfModifiedSince != null)
				msgs = ((InternalEObject)newIfModifiedSince).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__IF_MODIFIED_SINCE, null, msgs);
	...
	public NotificationChain basicSetIfNoneExist(org.hl7.fhir.String newIfNoneExist, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__IF_NONE_EXIST, oldIfNoneExist, newIfNoneExist);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIfNoneExist(org.hl7.fhir.String newIfNoneExist) {
		if (newIfNoneExist != ifNoneExist) {
			NotificationChain msgs = null;
			if (ifNoneExist != null)
				msgs = ((InternalEObject)ifNoneExist).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__IF_NONE_EXIST, null, msgs);
			if (newIfNoneExist != null)
				msgs = ((InternalEObject)newIfNoneExist).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.BUNDLE_REQUEST__IF_NONE_EXIST, null, msgs);
			msgs = basicSetIfNoneExist(newIfNoneExist, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.BUNDLE_REQUEST__IF_NONE_EXIST, newIfNoneExist, newIfNoneExist));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.BUNDLE_REQUEST__METHOD:
				return basicSetMethod(null, msgs);
			case FhirPackage.BUNDLE_REQUEST__URL:
