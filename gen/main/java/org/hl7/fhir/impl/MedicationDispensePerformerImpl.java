 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.MedicationDispensePerformerImpl#getFunction <em>Function</em>}</li>
...
public class MedicationDispensePerformerImpl extends BackboneElementImpl implements MedicationDispensePerformer {
	...
	public NotificationChain basicSetFunction(CodeableConcept newFunction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICATION_DISPENSE_PERFORMER__FUNCTION, oldFunction, newFunction);
	...
	public void setFunction(CodeableConcept newFunction) {
		if (newFunction != function) {
			...
			if (function != null)
				msgs = ((InternalEObject)function).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICATION_DISPENSE_PERFORMER__FUNCTION, null, msgs);
			if (newFunction != null)
				msgs = ((InternalEObject)newFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICATION_DISPENSE_PERFORMER__FUNCTION, null, msgs);
			msgs = basicSetFunction(newFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICATION_DISPENSE_PERFORMER__FUNCTION, newFunction, newFunction));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.MEDICATION_DISPENSE_PERFORMER__FUNCTION:
