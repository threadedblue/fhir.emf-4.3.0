 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.TestReportSetupImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestReportSetupImpl extends BackboneElementImpl implements TestReportSetup {
	 ...
	 * @ordered
	 */
	protected EList<TestReportAction> action;
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getTestReportSetup();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.TEST_REPORT_SETUP__ACTION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.TEST_REPORT_SETUP__ACTION:
				getAction().clear();
				getAction().addAll((Collection<? extends TestReportAction>)newValue);
				return;
		}
