 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.DateTimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateTimeImpl extends ElementImpl implements DateTime {
	/**
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getDateTime();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.DATE_TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FhirPackage.DATE_TIME__VALUE:
				return getValue();
		}
