...
public interface ResponseType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ResponseTypeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ResponseTypeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ResponseTypeEnum)
	 * @see org.hl7.fhir.FhirPackage#getResponseType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ResponseTypeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ResponseTypeEnum value);
