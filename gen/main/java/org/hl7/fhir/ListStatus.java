...
public interface ListStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ListStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ListStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ListStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getListStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ListStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ListStatusEnum value);
