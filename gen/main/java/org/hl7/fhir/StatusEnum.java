 ...
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getStatusEnum()
 * @model extendedMetaData="name='statusEnum'"
 * @generated
 */
public enum StatusEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final StatusEnum[] VALUES_ARRAY =
		new StatusEnum[] {
			ATTESTED,
			VALIDATED,
			IN_PROCESS,
	 ...
	 * @generated
	 */
	public static final List<StatusEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static StatusEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StatusEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private StatusEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
