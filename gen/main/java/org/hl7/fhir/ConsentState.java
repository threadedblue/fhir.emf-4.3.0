...
public interface ConsentState extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ConsentStateEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ConsentStateEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ConsentStateEnum)
	 * @see org.hl7.fhir.FhirPackage#getConsentState_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ConsentStateEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ConsentStateEnum value);
