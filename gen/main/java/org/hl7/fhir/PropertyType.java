...
public interface PropertyType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.PropertyTypeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.PropertyTypeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(PropertyTypeEnum)
	 * @see org.hl7.fhir.FhirPackage#getPropertyType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	PropertyTypeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(PropertyTypeEnum value);
