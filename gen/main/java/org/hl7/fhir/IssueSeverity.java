...
public interface IssueSeverity extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.IssueSeverityEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.IssueSeverityEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(IssueSeverityEnum)
	 * @see org.hl7.fhir.FhirPackage#getIssueSeverity_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	IssueSeverityEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(IssueSeverityEnum value);
