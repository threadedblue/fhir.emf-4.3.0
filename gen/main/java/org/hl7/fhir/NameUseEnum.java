...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Name Use Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getNameUseEnum()
 * @model extendedMetaData="name='NameUseEnum'"
 * @generated
 */
public enum NameUseEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Name Use Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NameUseEnum[] VALUES_ARRAY =
		new NameUseEnum[] {
			USUAL,
			OFFICIAL,
			TEMP,
	...
	/**
	 * A public read-only list of all the '<em><b>Name Use Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NameUseEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Name Use Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NameUseEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NameUseEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Name Use Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static NameUseEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NameUseEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Name Use Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NameUseEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private NameUseEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
