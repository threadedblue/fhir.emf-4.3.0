...
public interface ConsentDataMeaning extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ConsentDataMeaningEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ConsentDataMeaningEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ConsentDataMeaningEnum)
	 * @see org.hl7.fhir.FhirPackage#getConsentDataMeaning_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ConsentDataMeaningEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ConsentDataMeaningEnum value);
