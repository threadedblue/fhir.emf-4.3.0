...
public interface CompartmentType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.CompartmentTypeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.CompartmentTypeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(CompartmentTypeEnum)
	 * @see org.hl7.fhir.FhirPackage#getCompartmentType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	CompartmentTypeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(CompartmentTypeEnum value);
