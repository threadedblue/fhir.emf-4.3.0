...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Task Intent Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getTaskIntentEnum()
 * @model extendedMetaData="name='TaskIntentEnum'"
 * @generated
 */
public enum TaskIntentEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Task Intent Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TaskIntentEnum[] VALUES_ARRAY =
		new TaskIntentEnum[] {
			UNKNOWN,
			PROPOSAL,
			PLAN,
	...
	/**
	 * A public read-only list of all the '<em><b>Task Intent Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TaskIntentEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Task Intent Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TaskIntentEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TaskIntentEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Task Intent Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static TaskIntentEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TaskIntentEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Task Intent Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TaskIntentEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TaskIntentEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
