...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Task Status Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getTaskStatusEnum()
 * @model extendedMetaData="name='TaskStatusEnum'"
 * @generated
 */
public enum TaskStatusEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Task Status Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TaskStatusEnum[] VALUES_ARRAY =
		new TaskStatusEnum[] {
			DRAFT,
			REQUESTED,
			RECEIVED,
	...
	/**
	 * A public read-only list of all the '<em><b>Task Status Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TaskStatusEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Task Status Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static TaskStatusEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TaskStatusEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Task Status Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Task Status Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private TaskStatusEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
