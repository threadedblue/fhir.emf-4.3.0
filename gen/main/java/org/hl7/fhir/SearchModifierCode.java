...
public interface SearchModifierCode extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.SearchModifierCodeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.SearchModifierCodeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(SearchModifierCodeEnum)
	 * @see org.hl7.fhir.FhirPackage#getSearchModifierCode_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	SearchModifierCodeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(SearchModifierCodeEnum value);
