...
public interface PublicationStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.PublicationStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.PublicationStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(PublicationStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getPublicationStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	PublicationStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(PublicationStatusEnum value);
