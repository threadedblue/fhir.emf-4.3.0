...
public interface IssueType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.IssueTypeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.IssueTypeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(IssueTypeEnum)
	 * @see org.hl7.fhir.FhirPackage#getIssueType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	IssueTypeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(IssueTypeEnum value);
