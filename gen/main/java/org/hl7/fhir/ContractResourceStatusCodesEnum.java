...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Contract Resource Status Codes Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getContractResourceStatusCodesEnum()
 * @model extendedMetaData="name='ContractResourceStatusCodesEnum'"
 * @generated
 */
public enum ContractResourceStatusCodesEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Contract Resource Status Codes Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ContractResourceStatusCodesEnum[] VALUES_ARRAY =
		new ContractResourceStatusCodesEnum[] {
			AMENDED,
			APPENDED,
			CANCELLED,
			DISPUTED,
	...
	/**
	 * A public read-only list of all the '<em><b>Contract Resource Status Codes Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ContractResourceStatusCodesEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Contract Resource Status Codes Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ContractResourceStatusCodesEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ContractResourceStatusCodesEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Contract Resource Status Codes Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ContractResourceStatusCodesEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ContractResourceStatusCodesEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Contract Resource Status Codes Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ContractResourceStatusCodesEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ContractResourceStatusCodesEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
