...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Structure Map Transform Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getStructureMapTransformEnum()
 * @model extendedMetaData="name='StructureMapTransformEnum'"
 * @generated
 */
public enum StructureMapTransformEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Structure Map Transform Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StructureMapTransformEnum[] VALUES_ARRAY =
		new StructureMapTransformEnum[] {
			CREATE,
			COPY,
			TRUNCATE,
			ESCAPE,
	...
	/**
	 * A public read-only list of all the '<em><b>Structure Map Transform Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StructureMapTransformEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Structure Map Transform Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static StructureMapTransformEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StructureMapTransformEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Structure Map Transform Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static StructureMapTransformEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StructureMapTransformEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Structure Map Transform Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static StructureMapTransformEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StructureMapTransformEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
