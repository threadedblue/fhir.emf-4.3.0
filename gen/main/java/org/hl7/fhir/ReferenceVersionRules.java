...
public interface ReferenceVersionRules extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ReferenceVersionRulesEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ReferenceVersionRulesEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ReferenceVersionRulesEnum)
	 * @see org.hl7.fhir.FhirPackage#getReferenceVersionRules_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ReferenceVersionRulesEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ReferenceVersionRulesEnum value);
