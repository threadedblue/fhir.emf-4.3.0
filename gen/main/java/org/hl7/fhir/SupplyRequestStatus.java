...
public interface SupplyRequestStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.SupplyRequestStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.SupplyRequestStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(SupplyRequestStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getSupplyRequestStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	SupplyRequestStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(SupplyRequestStatusEnum value);
