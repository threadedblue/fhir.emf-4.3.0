...
public interface FlagStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.FlagStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.FlagStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(FlagStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getFlagStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	FlagStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(FlagStatusEnum value);
