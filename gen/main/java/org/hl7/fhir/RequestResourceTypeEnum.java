...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Request Resource Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getRequestResourceTypeEnum()
 * @model extendedMetaData="name='RequestResourceTypeEnum'"
 * @generated
 */
public enum RequestResourceTypeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Request Resource Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RequestResourceTypeEnum[] VALUES_ARRAY =
		new RequestResourceTypeEnum[] {
			APPOINTMENT,
	...
	/**
	 * A public read-only list of all the '<em><b>Request Resource Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RequestResourceTypeEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Request Resource Type Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RequestResourceTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RequestResourceTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Request Resource Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static RequestResourceTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RequestResourceTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Request Resource Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RequestResourceTypeEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RequestResourceTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
