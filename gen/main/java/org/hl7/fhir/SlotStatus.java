...
public interface SlotStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.SlotStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.SlotStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(SlotStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getSlotStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	SlotStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(SlotStatusEnum value);
