...
public interface MeasureReportType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.MeasureReportTypeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.MeasureReportTypeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(MeasureReportTypeEnum)
	 * @see org.hl7.fhir.FhirPackage#getMeasureReportType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	MeasureReportTypeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(MeasureReportTypeEnum value);
