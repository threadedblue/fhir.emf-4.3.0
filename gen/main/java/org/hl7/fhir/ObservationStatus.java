...
public interface ObservationStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ObservationStatusEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ObservationStatusEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ObservationStatusEnum)
	 * @see org.hl7.fhir.FhirPackage#getObservationStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ObservationStatusEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ObservationStatusEnum value);
