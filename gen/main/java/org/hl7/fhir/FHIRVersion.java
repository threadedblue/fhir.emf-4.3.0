...
public interface FHIRVersion extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.FHIRVersionEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.FHIRVersionEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(FHIRVersionEnum)
	 * @see org.hl7.fhir.FhirPackage#getFHIRVersion_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	FHIRVersionEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(FHIRVersionEnum value);
