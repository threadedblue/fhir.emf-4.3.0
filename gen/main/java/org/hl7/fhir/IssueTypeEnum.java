...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Issue Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getIssueTypeEnum()
 * @model extendedMetaData="name='IssueTypeEnum'"
 * @generated
 */
public enum IssueTypeEnum implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Issue Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IssueTypeEnum[] VALUES_ARRAY =
		new IssueTypeEnum[] {
			INVALID,
			STRUCTURE,
			REQUIRED,
	...
	/**
	 * A public read-only list of all the '<em><b>Issue Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<IssueTypeEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Issue Type Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static IssueTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IssueTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Issue Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static IssueTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IssueTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Issue Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static IssueTypeEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private IssueTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
