...
public interface ConstraintSeverity extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ConstraintSeverityEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ConstraintSeverityEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ConstraintSeverityEnum)
	 * @see org.hl7.fhir.FhirPackage#getConstraintSeverity_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ConstraintSeverityEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ConstraintSeverityEnum value);
