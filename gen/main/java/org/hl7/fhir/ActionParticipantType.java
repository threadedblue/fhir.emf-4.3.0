...
public interface ActionParticipantType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ActionParticipantTypeEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ActionParticipantTypeEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ActionParticipantTypeEnum)
	 * @see org.hl7.fhir.FhirPackage#getActionParticipantType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ActionParticipantTypeEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ActionParticipantTypeEnum value);
