...
public interface ContactPointUse extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ContactPointUseEnum}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ContactPointUseEnum
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ContactPointUseEnum)
	 * @see org.hl7.fhir.FhirPackage#getContactPointUse_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ContactPointUseEnum getValue();
	 ...
	 * @generated
	 */
	void setValue(ContactPointUseEnum value);
