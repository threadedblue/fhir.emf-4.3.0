...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Care Plan Activity Status Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getCarePlanActivityStatusEnum()
 * @model extendedMetaData="name='CarePlanActivityStatusEnum'"
 * @generated
 */
public enum CarePlanActivityStatusEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Care Plan Activity Status Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CarePlanActivityStatusEnum[] VALUES_ARRAY =
		new CarePlanActivityStatusEnum[] {
			NOT_STARTED,
			SCHEDULED,
			IN_PROGRESS,
			ON_HOLD,
	...
	/**
	 * A public read-only list of all the '<em><b>Care Plan Activity Status Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CarePlanActivityStatusEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Care Plan Activity Status Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CarePlanActivityStatusEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CarePlanActivityStatusEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Care Plan Activity Status Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static CarePlanActivityStatusEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CarePlanActivityStatusEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Care Plan Activity Status Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static CarePlanActivityStatusEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CarePlanActivityStatusEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
