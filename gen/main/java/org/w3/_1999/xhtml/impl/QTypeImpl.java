 ...
 *   <li>{@link org.w3._1999.xhtml.impl.QTypeImpl#getDir <em>Dir</em>}</li>
...
public class QTypeImpl extends InlineImpl implements QType {
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.QTYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.QTYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.QTYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(Object newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.QTYPE__LANG1, oldLang1, lang1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XhtmlPackage.QTYPE__CLASS:
				return getClass_();
			case XhtmlPackage.QTYPE__DIR:
				return getDir();
			case XhtmlPackage.QTYPE__ID:
				return getId();
			case XhtmlPackage.QTYPE__LANG:
				return getLang();
			case XhtmlPackage.QTYPE__LANG1:
				return getLang1();
