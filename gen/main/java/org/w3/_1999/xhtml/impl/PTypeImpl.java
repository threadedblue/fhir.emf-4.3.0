 ...
 *   <li>{@link org.w3._1999.xhtml.impl.PTypeImpl#getDir <em>Dir</em>}</li>
...
public class PTypeImpl extends InlineImpl implements PType {
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PTYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.PTYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PTYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(Object newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PTYPE__LANG1, oldLang1, lang1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.PTYPE__CLASS:
				return getClass_();
			case XhtmlPackage.PTYPE__DIR:
				return getDir();
			case XhtmlPackage.PTYPE__ID:
				return getId();
			case XhtmlPackage.PTYPE__LANG:
				return getLang();
			case XhtmlPackage.PTYPE__LANG1:
				return getLang1();
