 ...
 *   <li>{@link org.w3._1999.xhtml.impl.AbbrTypeImpl#getDir <em>Dir</em>}</li>
...
public class AbbrTypeImpl extends InlineImpl implements AbbrType {
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.ABBR_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.ABBR_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.ABBR_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(Object newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.ABBR_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.ABBR_TYPE__CLASS:
				return getClass_();
			case XhtmlPackage.ABBR_TYPE__DIR:
				return getDir();
			case XhtmlPackage.ABBR_TYPE__ID:
				return getId();
			case XhtmlPackage.ABBR_TYPE__LANG:
				return getLang();
			case XhtmlPackage.ABBR_TYPE__LANG1:
				return getLang1();
