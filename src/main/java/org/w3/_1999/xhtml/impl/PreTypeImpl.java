 ...
 *   <li>{@link org.w3._1999.xhtml.impl.PreTypeImpl#getDir <em>Dir</em>}</li>
...
public class PreTypeImpl extends PreContentImpl implements PreType {
	...
	public void setDir(DirType newDir) {
		...
		dirESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__DIR, oldDir, dir, !oldDirESet));
	}
	...
	public void unsetDir() {
		...
		dirESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.PRE_TYPE__DIR, oldDir, DIR_EDEFAULT, oldDirESet));
	}
	...
	public void setLang(String newLang) {
		...
		lang = newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__LANG, oldLang, lang));
	}
	...
	public void setLang1(Object newLang1) {
		...
		lang1 = newLang1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__LANG1, oldLang1, lang1));
	}
	...
	public void setSpace(SpaceType newSpace) {
		...
		spaceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XhtmlPackage.PRE_TYPE__SPACE, oldSpace, space, !oldSpaceESet));
	}
	...
	public void unsetSpace() {
		...
		spaceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XhtmlPackage.PRE_TYPE__SPACE, oldSpace, SPACE_EDEFAULT, oldSpaceESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XhtmlPackage.PRE_TYPE__CLASS:
				return getClass_();
			case XhtmlPackage.PRE_TYPE__DIR:
				return getDir();
			case XhtmlPackage.PRE_TYPE__ID:
				return getId();
			case XhtmlPackage.PRE_TYPE__LANG:
				return getLang();
			case XhtmlPackage.PRE_TYPE__LANG1:
				return getLang1();
