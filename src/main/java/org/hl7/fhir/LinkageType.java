...
public interface LinkageType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.LinkageTypeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.LinkageTypeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(LinkageTypeList)
	 * @see org.hl7.fhir.FhirPackage#getLinkageType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	LinkageTypeList getValue();
	 ...
	 * @generated
	 */
	void setValue(LinkageTypeList value);
