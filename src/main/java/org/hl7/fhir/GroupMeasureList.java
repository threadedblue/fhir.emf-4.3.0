...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Group Measure List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getGroupMeasureList()
 * @model extendedMetaData="name='GroupMeasure-list'"
 * @generated
 */
public enum GroupMeasureList implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Group Measure List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final GroupMeasureList[] VALUES_ARRAY =
		new GroupMeasureList[] {
			MEAN,
			MEDIAN,
			MEAN_OF_MEAN,
			MEAN_OF_MEDIAN,
	...
	/**
	 * A public read-only list of all the '<em><b>Group Measure List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<GroupMeasureList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Group Measure List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static GroupMeasureList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GroupMeasureList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Group Measure List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static GroupMeasureList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GroupMeasureList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Group Measure List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static GroupMeasureList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private GroupMeasureList(int value, String name, String literal) {
		this.value = value;
		this.name = name;
