...
public interface VariableType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.VariableTypeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.VariableTypeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(VariableTypeList)
	 * @see org.hl7.fhir.FhirPackage#getVariableType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	VariableTypeList getValue();
	 ...
	 * @generated
	 */
	void setValue(VariableTypeList value);
