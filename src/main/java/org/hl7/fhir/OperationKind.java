...
public interface OperationKind extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.OperationKindList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.OperationKindList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(OperationKindList)
	 * @see org.hl7.fhir.FhirPackage#getOperationKind_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	OperationKindList getValue();
	 ...
	 * @generated
	 */
	void setValue(OperationKindList value);
