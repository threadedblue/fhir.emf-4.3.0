 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.DateImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateImpl extends ElementImpl implements Date {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getDate();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.DATE__VALUE, oldValue, value));
	}
