...
public class ActionParticipantTypeImpl extends ElementImpl implements ActionParticipantType {
	 ...
	 * @ordered
	 */
	protected static final ActionParticipantTypeList VALUE_EDEFAULT = ActionParticipantTypeList.PATIENT;
	 ...
	 * @ordered
	 */
	protected ActionParticipantTypeList value = VALUE_EDEFAULT;
	 ...
	 */
	@Override
	public ActionParticipantTypeList getValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(ActionParticipantTypeList newValue) {
		ActionParticipantTypeList oldValue = value;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.ACTION_PARTICIPANT_TYPE__VALUE:
				setValue((ActionParticipantTypeList)newValue);
				return;
		}
