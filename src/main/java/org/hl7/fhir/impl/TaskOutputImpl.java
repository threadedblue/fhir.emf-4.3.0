...
public class TaskOutputImpl extends BackboneElementImpl implements TaskOutput {
	...
	public NotificationChain basicSetValueContactDetail(ContactDetail newValueContactDetail, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_CONTACT_DETAIL, oldValueContactDetail, newValueContactDetail);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueContactDetail(ContactDetail newValueContactDetail) {
		if (newValueContactDetail != valueContactDetail) {
			...
			if (valueContactDetail != null)
				msgs = ((InternalEObject)valueContactDetail).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_CONTACT_DETAIL, null, msgs);
			if (newValueContactDetail != null)
				msgs = ((InternalEObject)newValueContactDetail).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_CONTACT_DETAIL, null, msgs);
			msgs = basicSetValueContactDetail(newValueContactDetail, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_CONTACT_DETAIL, newValueContactDetail, newValueContactDetail));
	}
	...
	public NotificationChain basicSetValueContributor(Contributor newValueContributor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_CONTRIBUTOR, oldValueContributor, newValueContributor);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueContributor(Contributor newValueContributor) {
		if (newValueContributor != valueContributor) {
			...
			if (valueContributor != null)
				msgs = ((InternalEObject)valueContributor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_CONTRIBUTOR, null, msgs);
			if (newValueContributor != null)
				msgs = ((InternalEObject)newValueContributor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_CONTRIBUTOR, null, msgs);
			msgs = basicSetValueContributor(newValueContributor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_CONTRIBUTOR, newValueContributor, newValueContributor));
	}
	...
	public NotificationChain basicSetValueDataRequirement(DataRequirement newValueDataRequirement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_DATA_REQUIREMENT, oldValueDataRequirement, newValueDataRequirement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueDataRequirement(DataRequirement newValueDataRequirement) {
		if (newValueDataRequirement != valueDataRequirement) {
			...
			if (valueDataRequirement != null)
				msgs = ((InternalEObject)valueDataRequirement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_DATA_REQUIREMENT, null, msgs);
			if (newValueDataRequirement != null)
				msgs = ((InternalEObject)newValueDataRequirement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_DATA_REQUIREMENT, null, msgs);
	...
	public NotificationChain basicSetValueParameterDefinition(ParameterDefinition newValueParameterDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_PARAMETER_DEFINITION, oldValueParameterDefinition, newValueParameterDefinition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueParameterDefinition(ParameterDefinition newValueParameterDefinition) {
		if (newValueParameterDefinition != valueParameterDefinition) {
			...
			if (valueParameterDefinition != null)
				msgs = ((InternalEObject)valueParameterDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_PARAMETER_DEFINITION, null, msgs);
			if (newValueParameterDefinition != null)
				msgs = ((InternalEObject)newValueParameterDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_PARAMETER_DEFINITION, null, msgs);
			msgs = basicSetValueParameterDefinition(newValueParameterDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_PARAMETER_DEFINITION, newValueParameterDefinition, newValueParameterDefinition));
	}
	...
	public NotificationChain basicSetValueRelatedArtifact(RelatedArtifact newValueRelatedArtifact, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_RELATED_ARTIFACT, oldValueRelatedArtifact, newValueRelatedArtifact);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueRelatedArtifact(RelatedArtifact newValueRelatedArtifact) {
		if (newValueRelatedArtifact != valueRelatedArtifact) {
			...
			if (valueRelatedArtifact != null)
				msgs = ((InternalEObject)valueRelatedArtifact).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_RELATED_ARTIFACT, null, msgs);
			if (newValueRelatedArtifact != null)
				msgs = ((InternalEObject)newValueRelatedArtifact).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_RELATED_ARTIFACT, null, msgs);
			msgs = basicSetValueRelatedArtifact(newValueRelatedArtifact, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_RELATED_ARTIFACT, newValueRelatedArtifact, newValueRelatedArtifact));
	}
	...
	public NotificationChain basicSetValueTriggerDefinition(TriggerDefinition newValueTriggerDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_TRIGGER_DEFINITION, oldValueTriggerDefinition, newValueTriggerDefinition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueTriggerDefinition(TriggerDefinition newValueTriggerDefinition) {
		if (newValueTriggerDefinition != valueTriggerDefinition) {
			...
			if (valueTriggerDefinition != null)
				msgs = ((InternalEObject)valueTriggerDefinition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_TRIGGER_DEFINITION, null, msgs);
			if (newValueTriggerDefinition != null)
				msgs = ((InternalEObject)newValueTriggerDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_TRIGGER_DEFINITION, null, msgs);
			msgs = basicSetValueTriggerDefinition(newValueTriggerDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_TRIGGER_DEFINITION, newValueTriggerDefinition, newValueTriggerDefinition));
	}
	...
	public NotificationChain basicSetValueUsageContext(UsageContext newValueUsageContext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_USAGE_CONTEXT, oldValueUsageContext, newValueUsageContext);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValueUsageContext(UsageContext newValueUsageContext) {
		if (newValueUsageContext != valueUsageContext) {
			...
			if (valueUsageContext != null)
				msgs = ((InternalEObject)valueUsageContext).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_USAGE_CONTEXT, null, msgs);
			if (newValueUsageContext != null)
				msgs = ((InternalEObject)newValueUsageContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.TASK_OUTPUT__VALUE_USAGE_CONTEXT, null, msgs);
			msgs = basicSetValueUsageContext(newValueUsageContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.TASK_OUTPUT__VALUE_USAGE_CONTEXT, newValueUsageContext, newValueUsageContext));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FhirPackage.TASK_OUTPUT__VALUE_TRIGGER_DEFINITION:
