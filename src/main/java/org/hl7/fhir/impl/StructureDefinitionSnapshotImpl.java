 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.StructureDefinitionSnapshotImpl#getElement <em>Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDefinitionSnapshotImpl extends BackboneElementImpl implements StructureDefinitionSnapshot {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getStructureDefinitionSnapshot();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.STRUCTURE_DEFINITION_SNAPSHOT__ELEMENT:
