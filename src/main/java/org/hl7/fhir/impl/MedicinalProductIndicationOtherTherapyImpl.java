 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.MedicinalProductIndicationOtherTherapyImpl#getTherapyRelationshipType <em>Therapy Relationship Type</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.MedicinalProductIndicationOtherTherapyImpl#getMedicationCodeableConcept <em>Medication Codeable Concept</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.MedicinalProductIndicationOtherTherapyImpl#getMedicationReference <em>Medication Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MedicinalProductIndicationOtherTherapyImpl extends BackboneElementImpl implements MedicinalProductIndicationOtherTherapy {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getMedicinalProductIndicationOtherTherapy();
	}
	...
	public NotificationChain basicSetTherapyRelationshipType(CodeableConcept newTherapyRelationshipType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__THERAPY_RELATIONSHIP_TYPE, oldTherapyRelationshipType, newTherapyRelationshipType);
	...
	public void setTherapyRelationshipType(CodeableConcept newTherapyRelationshipType) {
		if (newTherapyRelationshipType != therapyRelationshipType) {
			...
			if (therapyRelationshipType != null)
				msgs = ((InternalEObject)therapyRelationshipType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__THERAPY_RELATIONSHIP_TYPE, null, msgs);
			if (newTherapyRelationshipType != null)
				msgs = ((InternalEObject)newTherapyRelationshipType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__THERAPY_RELATIONSHIP_TYPE, null, msgs);
			msgs = basicSetTherapyRelationshipType(newTherapyRelationshipType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__THERAPY_RELATIONSHIP_TYPE, newTherapyRelationshipType, newTherapyRelationshipType));
	}
	...
	public NotificationChain basicSetMedicationCodeableConcept(CodeableConcept newMedicationCodeableConcept, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_CODEABLE_CONCEPT, oldMedicationCodeableConcept, newMedicationCodeableConcept);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMedicationCodeableConcept(CodeableConcept newMedicationCodeableConcept) {
		if (newMedicationCodeableConcept != medicationCodeableConcept) {
			...
			if (medicationCodeableConcept != null)
				msgs = ((InternalEObject)medicationCodeableConcept).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_CODEABLE_CONCEPT, null, msgs);
			if (newMedicationCodeableConcept != null)
				msgs = ((InternalEObject)newMedicationCodeableConcept).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_CODEABLE_CONCEPT, null, msgs);
			msgs = basicSetMedicationCodeableConcept(newMedicationCodeableConcept, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_CODEABLE_CONCEPT, newMedicationCodeableConcept, newMedicationCodeableConcept));
	}
	...
	public NotificationChain basicSetMedicationReference(Reference newMedicationReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_REFERENCE, oldMedicationReference, newMedicationReference);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMedicationReference(Reference newMedicationReference) {
		if (newMedicationReference != medicationReference) {
			...
			if (medicationReference != null)
				msgs = ((InternalEObject)medicationReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_REFERENCE, null, msgs);
			if (newMedicationReference != null)
				msgs = ((InternalEObject)newMedicationReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_REFERENCE, null, msgs);
			msgs = basicSetMedicationReference(newMedicationReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_REFERENCE, newMedicationReference, newMedicationReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__THERAPY_RELATIONSHIP_TYPE:
				return basicSetTherapyRelationshipType(null, msgs);
			case FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_CODEABLE_CONCEPT:
				return basicSetMedicationCodeableConcept(null, msgs);
			case FhirPackage.MEDICINAL_PRODUCT_INDICATION_OTHER_THERAPY__MEDICATION_REFERENCE:
