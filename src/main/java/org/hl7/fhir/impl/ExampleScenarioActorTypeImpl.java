...
public class ExampleScenarioActorTypeImpl extends ElementImpl implements ExampleScenarioActorType {
	 ...
	 * @ordered
	 */
	protected static final ExampleScenarioActorTypeList VALUE_EDEFAULT = ExampleScenarioActorTypeList.PERSON;
	 ...
	 * @ordered
	 */
	protected ExampleScenarioActorTypeList value = VALUE_EDEFAULT;
	 ...
	 */
	@Override
	public ExampleScenarioActorTypeList getValue() {
		return value;
	}
	 ...
	 */
	@Override
	public void setValue(ExampleScenarioActorTypeList newValue) {
		ExampleScenarioActorTypeList oldValue = value;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.EXAMPLE_SCENARIO_ACTOR_TYPE__VALUE:
				setValue((ExampleScenarioActorTypeList)newValue);
				return;
		}
