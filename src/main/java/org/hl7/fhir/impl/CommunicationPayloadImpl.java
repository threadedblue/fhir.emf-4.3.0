 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.CommunicationPayloadImpl#getContentString <em>Content String</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.CommunicationPayloadImpl#getContentAttachment <em>Content Attachment</em>}</li>
 *   <li>{@link org.hl7.fhir.impl.CommunicationPayloadImpl#getContentReference <em>Content Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationPayloadImpl extends BackboneElementImpl implements CommunicationPayload {
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getCommunicationPayload();
	}
	...
	public NotificationChain basicSetContentString(org.hl7.fhir.String newContentString, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_STRING, oldContentString, newContentString);
	...
	public void setContentString(org.hl7.fhir.String newContentString) {
		if (newContentString != contentString) {
			...
			if (contentString != null)
				msgs = ((InternalEObject)contentString).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_STRING, null, msgs);
			if (newContentString != null)
				msgs = ((InternalEObject)newContentString).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_STRING, null, msgs);
			msgs = basicSetContentString(newContentString, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_STRING, newContentString, newContentString));
	}
	...
	public NotificationChain basicSetContentAttachment(Attachment newContentAttachment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_ATTACHMENT, oldContentAttachment, newContentAttachment);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContentAttachment(Attachment newContentAttachment) {
		if (newContentAttachment != contentAttachment) {
			...
			if (contentAttachment != null)
				msgs = ((InternalEObject)contentAttachment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_ATTACHMENT, null, msgs);
			if (newContentAttachment != null)
				msgs = ((InternalEObject)newContentAttachment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_ATTACHMENT, null, msgs);
			msgs = basicSetContentAttachment(newContentAttachment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_ATTACHMENT, newContentAttachment, newContentAttachment));
	}
	...
	public NotificationChain basicSetContentReference(Reference newContentReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_REFERENCE, oldContentReference, newContentReference);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContentReference(Reference newContentReference) {
		if (newContentReference != contentReference) {
			...
			if (contentReference != null)
				msgs = ((InternalEObject)contentReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_REFERENCE, null, msgs);
			if (newContentReference != null)
				msgs = ((InternalEObject)newContentReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_REFERENCE, null, msgs);
			msgs = basicSetContentReference(newContentReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_REFERENCE, newContentReference, newContentReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_STRING:
				return basicSetContentString(null, msgs);
			case FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_ATTACHMENT:
				return basicSetContentAttachment(null, msgs);
			case FhirPackage.COMMUNICATION_PAYLOAD__CONTENT_REFERENCE:
