 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir.impl.ParametersImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersImpl extends ResourceImpl implements Parameters {
	 ...
	 * @ordered
	 */
	protected EList<ParametersParameter> parameter;
	...
	protected EClass eStaticClass() {
		return FhirPackage.eINSTANCE.getParameters();
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FhirPackage.PARAMETERS__PARAMETER:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FhirPackage.PARAMETERS__PARAMETER:
				getParameter().clear();
				getParameter().addAll((Collection<? extends ParametersParameter>)newValue);
				return;
		}
