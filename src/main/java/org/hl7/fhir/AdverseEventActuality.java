...
public interface AdverseEventActuality extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.AdverseEventActualityList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.AdverseEventActualityList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(AdverseEventActualityList)
	 * @see org.hl7.fhir.FhirPackage#getAdverseEventActuality_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	AdverseEventActualityList getValue();
	 ...
	 * @generated
	 */
	void setValue(AdverseEventActualityList value);
