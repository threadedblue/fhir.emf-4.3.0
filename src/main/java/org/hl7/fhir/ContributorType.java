...
public interface ContributorType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ContributorTypeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ContributorTypeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ContributorTypeList)
	 * @see org.hl7.fhir.FhirPackage#getContributorType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ContributorTypeList getValue();
	 ...
	 * @generated
	 */
	void setValue(ContributorTypeList value);
