...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Related Artifact Type List</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.hl7.fhir.FhirPackage#getRelatedArtifactTypeList()
 * @model extendedMetaData="name='RelatedArtifactType-list'"
 * @generated
 */
public enum RelatedArtifactTypeList implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Related Artifact Type List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RelatedArtifactTypeList[] VALUES_ARRAY =
		new RelatedArtifactTypeList[] {
			DOCUMENTATION,
			JUSTIFICATION,
			CITATION,
			PREDECESSOR,
	...
	/**
	 * A public read-only list of all the '<em><b>Related Artifact Type List</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RelatedArtifactTypeList> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Related Artifact Type List</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RelatedArtifactTypeList get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RelatedArtifactTypeList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Related Artifact Type List</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static RelatedArtifactTypeList getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RelatedArtifactTypeList result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Related Artifact Type List</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static RelatedArtifactTypeList get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RelatedArtifactTypeList(int value, String name, String literal) {
		this.value = value;
		this.name = name;
