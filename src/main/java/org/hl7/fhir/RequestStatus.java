...
public interface RequestStatus extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.RequestStatusList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.RequestStatusList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(RequestStatusList)
	 * @see org.hl7.fhir.FhirPackage#getRequestStatus_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	RequestStatusList getValue();
	 ...
	 * @generated
	 */
	void setValue(RequestStatusList value);
