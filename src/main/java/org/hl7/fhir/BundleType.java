...
public interface BundleType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.BundleTypeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.BundleTypeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(BundleTypeList)
	 * @see org.hl7.fhir.FhirPackage#getBundleType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	BundleTypeList getValue();
	 ...
	 * @generated
	 */
	void setValue(BundleTypeList value);
