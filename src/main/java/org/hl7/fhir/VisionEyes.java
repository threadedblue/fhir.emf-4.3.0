...
public interface VisionEyes extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.VisionEyesList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.VisionEyesList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(VisionEyesList)
	 * @see org.hl7.fhir.FhirPackage#getVisionEyes_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	VisionEyesList getValue();
	 ...
	 * @generated
	 */
	void setValue(VisionEyesList value);
