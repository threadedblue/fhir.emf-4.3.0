...
public interface ActionConditionKind extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.ActionConditionKindList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.ActionConditionKindList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(ActionConditionKindList)
	 * @see org.hl7.fhir.FhirPackage#getActionConditionKind_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	ActionConditionKindList getValue();
	 ...
	 * @generated
	 */
	void setValue(ActionConditionKindList value);
