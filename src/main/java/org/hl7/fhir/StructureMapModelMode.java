...
public interface StructureMapModelMode extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.StructureMapModelModeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.StructureMapModelModeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(StructureMapModelModeList)
	 * @see org.hl7.fhir.FhirPackage#getStructureMapModelMode_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	StructureMapModelModeList getValue();
	 ...
	 * @generated
	 */
	void setValue(StructureMapModelModeList value);
