...
public interface QuestionnaireItemOperator extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.QuestionnaireItemOperatorList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.QuestionnaireItemOperatorList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(QuestionnaireItemOperatorList)
	 * @see org.hl7.fhir.FhirPackage#getQuestionnaireItemOperator_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	QuestionnaireItemOperatorList getValue();
	 ...
	 * @generated
	 */
	void setValue(QuestionnaireItemOperatorList value);
