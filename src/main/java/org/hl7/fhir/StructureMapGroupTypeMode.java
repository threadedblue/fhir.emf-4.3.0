...
public interface StructureMapGroupTypeMode extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.StructureMapGroupTypeModeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.StructureMapGroupTypeModeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(StructureMapGroupTypeModeList)
	 * @see org.hl7.fhir.FhirPackage#getStructureMapGroupTypeMode_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	StructureMapGroupTypeModeList getValue();
	 ...
	 * @generated
	 */
	void setValue(StructureMapGroupTypeModeList value);
