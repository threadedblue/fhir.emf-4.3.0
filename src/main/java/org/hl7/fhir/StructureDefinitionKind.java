...
public interface StructureDefinitionKind extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.StructureDefinitionKindList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.StructureDefinitionKindList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(StructureDefinitionKindList)
	 * @see org.hl7.fhir.FhirPackage#getStructureDefinitionKind_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	StructureDefinitionKindList getValue();
	 ...
	 * @generated
	 */
	void setValue(StructureDefinitionKindList value);
