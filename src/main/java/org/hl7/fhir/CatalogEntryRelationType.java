...
public interface CatalogEntryRelationType extends Element {
	 ...
	 * The literals are from the enumeration {@link org.hl7.fhir.CatalogEntryRelationTypeList}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Value</em>' attribute.
	 * @see org.hl7.fhir.CatalogEntryRelationTypeList
	 * @see #isSetValue()
	 * @see #unsetValue()
	 * @see #setValue(CatalogEntryRelationTypeList)
	 * @see org.hl7.fhir.FhirPackage#getCatalogEntryRelationType_Value()
	 * @model unsettable="true"
	 *        extendedMetaData="kind='attribute' name='value'"
	 * @generated
	 */
	CatalogEntryRelationTypeList getValue();
	 ...
	 * @generated
	 */
	void setValue(CatalogEntryRelationTypeList value);
